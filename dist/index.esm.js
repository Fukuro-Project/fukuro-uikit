...
import styled, { useTheme, keyframes, css, ThemeProvider, createGlobalStyle } from 'styled-components';
...
var variants$6 = {
    ...
    gradients: {
        ...
        inverseBubblegum: "gradients.inverseBubblegum",
        cardHeader: "gradients.cardHeader",
        blue: "gradients.blue",
        violet: "gradients.violet",
        violetAlt: "gradients.violetAlt",
        gold: "gradients.gold"
    }
};
...
var StyledCard$1 = styled.div(templateObject_1$_ || (templateObject_1$_ = __makeTemplateObject(["\n  background-color: ", ";\n  border: ", ";\n  border-radius: ", ";\n  box-shadow: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n"], ["\n  background-color: ", ";\n  border: ", ";\n  border-radius: ", ";\n  box-shadow: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
...
var getThemeColor$1 = function (_a) {
    var theme = _a.theme, _b = _a.variant, variant = _b === void 0 ? variants$6.primary : _b;
    switch (variant) {
        case variants$6.failure:
            return theme.colors.failure;
        case variants$6.primary:
            return theme.colors.primary;
        case variants$6.primaryBright:
            return theme.colors.primaryBright;
        case variants$6.primaryDark:
            return theme.colors.primaryDark;
        case variants$6.secondary:
            return theme.colors.secondary;
        case variants$6.success:
            return theme.colors.success;
        case variants$6.warning:
            return theme.colors.warning;
        case variants$6.binance:
            return theme.colors.binance;
        case variants$6.overlay:
            return theme.colors.overlay;
        case variants$6.background:
            return theme.colors.background;
        case variants$6.backgroundDisabled:
            return theme.colors.backgroundDisabled;
        case variants$6.backgroundAlt:
            return theme.colors.backgroundAlt;
        case variants$6.cardBorder:
            return theme.colors.cardBorder;
        case variants$6.contrast:
            return theme.colors.contrast;
        case variants$6.dropdown:
            return theme.colors.dropdown;
        case variants$6.dropdownDeep:
            return theme.colors.dropdownDeep;
        case variants$6.invertedContrast:
            return theme.colors.invertedContrast;
        case variants$6.input:
            return theme.colors.input;
        case variants$6.inputSecondary:
            return theme.colors.inputSecondary;
        case variants$6.tertiary:
            return theme.colors.tertiary;
        case variants$6.text:
            return theme.colors.text;
        case variants$6.textDisabled:
            return theme.colors.textDisabled;
        case variants$6.textSubtle:
            return theme.colors.textSubtle;
        case variants$6.disabled:
            return theme.colors.disabled;
        case variants$6.gradients.bubblegum:
            return theme.colors.gradients.bubblegum;
        case variants$6.gradients.inverseBubblegum:
            return theme.colors.gradients.inverseBubblegum;
        case variants$6.gradients.cardHeader:
            return theme.colors.gradients.cardHeader;
        case variants$6.gradients.blue:
            return theme.colors.gradients.blue;
        case variants$6.gradients.violet:
            return theme.colors.gradients.violet;
        case variants$6.gradients.violetAlt:
            return theme.colors.gradients.violetAlt;
        case variants$6.gradients.gold:
            return theme.colors.gradients.gold;
        default:
            return theme.colors.secondary;
    }
};
var StyledCard = styled(Card)(templateObject_1$V || (templateObject_1$V = __makeTemplateObject(["\n  padding: 1rem;\n  margin-bottom: 1rem;\n  position: relative;\n  background: ", ";\n  color: ", ";\n"], ["\n  padding: 1rem;\n  margin-bottom: 1rem;\n  position: relative;\n  background: ", ";\n  color: ", ";\n"])), getThemeColor$1, function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var ColorplateCard = function (_a) {
    var variant = _a.variant;
    var theme = useTheme();
    var hexCode = getThemeColor$1({ theme: theme, variant: variant });
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledCard, { variant: variant },
            variant,
...
var templateObject_1$U, templateObject_2$m, templateObject_3$9;
...
var Icon$12 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 290 290", version: "1.1" }, props),
        React.createElement("defs", { id: "defs4" },
            React.createElement("linearGradient", { id: "linearGradient3480" },
                React.createElement("stop", { id: "stop3482", stopColor: "#1a1a1a", offset: "0" }),
                React.createElement("stop", { id: "stop3484", stopColor: "#494949", offset: "1" })),
            React.createElement("linearGradient", { id: "linearGradient3669" },
                React.createElement("stop", { id: "stop3671", stopColor: "#ffd73b", offset: "0" }),
                React.createElement("stop", { id: "stop3673", stopColor: "#ee8400", offset: "1" })),
            React.createElement("filter", { id: "filter3641", height: "1.5977", width: "1.0943", "color-interpolation-filters": "sRGB", y: "-.29883", x: "-.047150" },
                React.createElement("feGaussianBlur", { id: "feGaussianBlur3643", stdDeviation: "0.67728367" })),
            React.createElement("filter", { id: "filter3866", height: "1.5887", width: "1.5832", colorInterpolationFilters: "sRGB", y: "-.29437", x: "-.29160" },
                React.createElement("feGaussianBlur", { id: "feGaussianBlur3868", stdDeviation: "3.7554505" })),
            React.createElement("filter", { id: "filter3900", height: "1.3351", width: "1.2598", colorInterpolationFilters: "sRGB", y: "-.16757", x: "-.12989" },
                React.createElement("feGaussianBlur", { id: "feGaussianBlur3902", stdDeviation: "3.9990335" })),
            React.createElement("filter", { id: "filter3912", height: "1.2909", width: "1.1581", colorInterpolationFilters: "sRGB", y: "-.14544", x: "-.079065" },
                React.createElement("feGaussianBlur", { id: "feGaussianBlur3914", stdDeviation: "0.39212011" })),
            React.createElement("filter", { id: "filter3927", height: "1.5755", width: "1.2527", colorInterpolationFilters: "sRGB", y: "-.28774", x: "-.12637" },
                React.createElement("feGaussianBlur", { id: "feGaussianBlur3929", stdDeviation: "1.1537473" })),
            React.createElement("linearGradient", { id: "linearGradient4231", y2: "152.37", xlinkHref: "#linearGradient3480", gradientUnits: "userSpaceOnUse", x2: "783.87", y1: "174.4", x1: "793.05" }),
            React.createElement("linearGradient", { id: "linearGradient4235", y2: "137.03", xlinkHref: "#linearGradient3480", gradientUnits: "userSpaceOnUse", x2: "765.43", gradientTransform: "translate(-9.75 310.52)", y1: "183.76", x1: "797.89" }),
            React.createElement("linearGradient", { id: "linearGradient4248", y2: "55.5", xlinkHref: "#linearGradient3669", gradientUnits: "userSpaceOnUse", x2: "192.25", gradientTransform: "translate(710.43 367.81)", y1: "72.875", x1: "183.12" }),
            React.createElement("linearGradient", { id: "linearGradient4254", y2: "21.311", xlinkHref: "#linearGradient3669", gradientUnits: "userSpaceOnUse", x2: "37.241", gradientTransform: "matrix(6.4001 0 0 6.4001 673.62 332.28)", y1: "24.615", x1: "29.023" }),
            React.createElement("linearGradient", { id: "linearGradient4257", y2: "1017.5", xlinkHref: "#linearGradient3669", gradientUnits: "userSpaceOnUse", x2: "15.644", gradientTransform: "matrix(6.4001 0 0 6.4001 666.87 -6101.5)", y1: "1023.9", x1: "22.384" }),
            React.createElement("linearGradient", { id: "linearGradient4260", y2: "814.86", gradientUnits: "userSpaceOnUse", x2: "119", gradientTransform: "translate(710.43 -428.55)", y1: "843.86", x1: "147.5" },
                React.createElement("stop", { id: "stop3933", stopColor: "#5f6b21", offset: "0" }),
                React.createElement("stop", { id: "stop3935", stopColor: "#39a905", offset: "1" })),
            React.createElement("linearGradient", { id: "linearGradient4266", y2: "29.798", xlinkHref: "#linearGradient3669", gradientUnits: "userSpaceOnUse", x2: "17.828", gradientTransform: "matrix(6.4001 0 0 6.4001 673.62 332.28)", y1: "25.848", x1: "8.9687" }),
            React.createElement("linearGradient", { id: "linearGradient4269", y2: "26.058", xlinkHref: "#linearGradient3669", gradientUnits: "userSpaceOnUse", x2: "25.219", gradientTransform: "matrix(6.4001 0 0 6.4001 673.62 24.012)", y1: "26.721", x1: "14.27" }),
            React.createElement("linearGradient", { id: "linearGradient4317", y2: "29.106", xlinkHref: "#linearGradient3669", gradientUnits: "userSpaceOnUse", x2: "31.867", gradientTransform: "matrix(6.4001 0 0 6.4001 673.62 24.012)", y1: "29.051", x1: "24.367" }),
            React.createElement("radialGradient", { id: "radialGradient4320", xlinkHref: "#linearGradient3669", gradientUnits: "userSpaceOnUse", cy: "1023.9", cx: "17.36", gradientTransform: "matrix(2.5639 5.7921 -4.9198 2.1778 5777.7 -2168.9)", r: "17.592" }),
            React.createElement("filter", { id: "filter4327", height: "1.2067", width: "1.1527", colorInterpolationFilters: "sRGB", y: "-.10335", x: "-.076327" },
                React.createElement("feGaussianBlur", { id: "feGaussianBlur4329", stdDeviation: "0.86017417" })),
            React.createElement("linearGradient", { id: "linearGradient4387", y2: "197.63", xlinkHref: "#linearGradient3480", gradientUnits: "userSpaceOnUse", x2: "895.75", y1: "229.45", x1: "905.49" }),
            React.createElement("radialGradient", { id: "radialGradient5180", gradientUnits: "userSpaceOnUse", cy: "1021.1", cx: "27.844", gradientTransform: "matrix(2.745 4.3867 -6.8695 4.2987 7760.1 -3989.7)", r: "17.592" },
                React.createElement("stop", { id: "stop3691", stopColor: "#fff690", offset: "0" }),
                React.createElement("stop", { id: "stop3693", stopColor: "#f2ff00", offset: "1" }))),
        React.createElement("g", { id: "layer1", transform: "translate(0 -762.36)" },
            React.createElement("g", { id: "g4389", transform: "translate(-688.87 405.75)" },
                React.createElement("path", { id: "path3269", d: "m40.943 39.253c0 1.5021-7.7174 2.7198-17.237 2.7198-9.5199 0-17.237-1.2177-17.237-2.7198s7.7174-2.7198 17.237-2.7198c9.5199 0 17.237 1.2177 17.237 2.7198z", fillRule: "evenodd", fillOpacity: ".76863", transform: "matrix(5.7451 0 0 7.092 690.09 311.71)", filter: "url(#filter3641)" }),
                React.createElement("path", { id: "path3275", style: { color: '#000000' }, d: "m820.66 143.59c-11.904 37.855-17.86 64.676-22.344 88.75 1.2534-0.0859 2.5054-0.17087 3.75-0.28125 9.4029-37.558 20.572-84.512 18.594-88.469zm-26.125 110.03c-1.441 8.3651-2.8575 16.694-4.4688 25.375 0 0 2.392-9.1046 5.7812-22.312-0.45739-0.0588-0.91771-0.0926-1.375-0.15625l0.0625-2.9062z", transform: "translate(0 308.27)", fill: "url(#linearGradient4269)" }),
                React.createElement("path", { id: "path3277", style: { color: '#000000' }, d: "m808.35 444.55c-70.245 28.458-77.248 111.47-71.522 131.07 0.3734-34.774 16.1-106.43 71.522-131.07z", fill: "url(#linearGradient4266)" }),
                React.createElement("path", { id: "path3279", style: { color: '#000000' }, d: "m846.91 144.47c0.78774 4.9719 4.1216 23.129 7.4062 44.531 0.85425 0.23009 1.7566 0.375 2.6875 0.375 1.1005 0 2.1671-0.18254 3.1562-0.5-3.2454-18.792-8.0092-35.354-13.25-44.406zm14.938 55.438c-1.9935 0.36302-3.9614 0.52288-5.8438 0.4375 0.90899 6.3521 1.7676 12.806 2.5312 19.188 1.723-0.6018 3.4439-1.21 5.1562-1.8438-0.44508-5.9448-1.0552-11.918-1.8438-17.781zm1.8125 54.719c-0.76044 0.0616-1.5203 0.1235-2.2812 0.1875 0.16958 8.1352-0.22313 14.865-1.4688 19.188 1.8125-5.4918 3.0312-12.086 3.75-19.375z", transform: "translate(0 308.27)", fill: "url(#linearGradient4317)" }),
                React.createElement("path", { id: "path3281", style: { color: '#000000' }, d: "m834.27 429.84c7.5448-25.606 12.221-33.501 24.47-44.624 13.04-3.4273 25.494-1.2867 23.917 10.941-22.558 17.618-16.346 15.167-34.573 37.421-6.2733 1.2678-12.547 2.5356-13.814-3.7377z", fill: "url(#linearGradient4260)" }),
                React.createElement("path", { id: "path3283", style: { color: '#000000' }, d: "m805.26 431.81c-10.54-3.5438-24.159-1.497-36.26-0.66562l-6.3205 3.6596c11.868-1.2832 32.481-6.1332 42.58-2.994z", fill: "url(#linearGradient4257)" }),
                React.createElement("path", { id: "path3285", style: { color: '#000000' }, d: "m879.88 448.71c21.981 17.712 39.521 90.721 37.746 118.13 11.108-41.271-13.074-104.92-37.746-118.13z", fill: "url(#linearGradient4254)" }),
                React.createElement("path", { id: "path3287", style: { color: '#000000' }, d: "m10.967 21.128c2.55-1.947 7.086-6.078 11.903-6.134-0.459-0.856-9.82-0.503-11.903 6.134z", fillOpacity: ".34821", transform: "matrix(6.4001 0 0 6.4001 669.62 330.78)", filter: "url(#filter3912)", fill: "#fff" }),
                React.createElement("path", { id: "path3289", d: "m47.73 182.64c0 9.275-6.0151 16.794-13.435 16.794-7.42 0-13.435-7.5188-13.435-16.794 0-9.275 6.0151-16.794 13.435-16.794 7.42 0 13.435 7.5188 13.435 16.794z", fillOpacity: ".31696", transform: "matrix(.80272 -.59635 .65913 .88722 598.93 421.58)", filter: "url(#filter3866)", fill: "#fff" }),
                React.createElement("path", { id: "path3291", d: "m866.34 600.83c28.242-13.948 54.147-28.049 73.893-57.276 0 0-6.1872 58.69-73.893 57.276z", fillOpacity: ".19643", filter: "url(#filter3900)" }),
                React.createElement("path", { id: "path3293", d: "m899.11 431.78-7.8125 0.15625 10.656 1.25c-0.93725-0.48914-1.8817-0.95974-2.8438-1.4062z", fill: "url(#linearGradient4248)" }),
                React.createElement("path", { id: "path3295", d: "m859.8 385.51c8.7836 1.187 17.138 2.8983 21.744 9.1924 0 0 3.5355-12.021-21.744-9.1924z", fillOpacity: ".35714", filter: "url(#filter3927)", fill: "#fff" }),
                React.createElement("path", { id: "path4227", d: "m723.89 179.86c59.893 4.8451 118.08-21.091 175.67-57.548 2.0009-1.2431 4.1287 0.1621 3.6779 2.1635-56.235 36.663-114.11 63.569-180.65 60.144-1.7401-1.5867-0.99523-3.7648 1.2981-4.7596z", transform: "translate(0 308.27)", fill: "url(#linearGradient4231)" }),
                React.createElement("path", { id: "path4233", d: "m758.28 486.05c3.3238-3.9664 21.717-7.9327 43.918-11.899 3.6103 10.161 5.3272 20.538-16.01 33.534-36.045-1.5816-26.048-14.12-27.909-21.635z", fill: "url(#linearGradient4235)" }),
                React.createElement("path", { id: "path4325", d: "m760.14 190.25c-0.85172-4.9765-1.0303-9.2799 0-12.374 9.4449-4.5288 17.791-5.7616 26.34-7.6014-11.01 4.5258-25.475 5.7466-26.34 19.976z", fillOpacity: ".34529", transform: "translate(0 308.27)", filter: "url(#filter4327)", fill: "#fff" })))));
};
...
var templateObject_1$N, templateObject_2$l, templateObject_3$8, templateObject_4$6;
...
var ButtonMenu$1 = function (_a) {
    var _b = _a.activeIndex, activeIndex = _b === void 0 ? 0 : _b, _c = _a.scale, scale = _c === void 0 ? scales$7.MD : _c, _d = _a.variant, variant = _d === void 0 ? variants$5.PRIMARY : _d, onItemClick = _a.onItemClick, children = _a.children, props = __rest(_a, ["activeIndex", "scale", "variant", "onItemClick", "children"]);
...
var templateObject_1$q, templateObject_2$d, templateObject_3$7, templateObject_4$5, templateObject_5$3, templateObject_6$2, templateObject_7$2;
...
var SvgStyled = styled.svg(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  enable-background: new 0 0 50 50;\n"], ["\n  enable-background: new 0 0 50 50;\n"])));
var Spinner = function () {
    var theme = useTheme();
    var color = theme.colors.binance;
    var _a = { width: 6, height: 30, duration: '0.8s' }, width = _a.width, height = _a.height, duration = _a.duration;
    return (React.createElement(Container$3, null,
        React.createElement(SvgStyled, { version: "1.1", id: "Layer_1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", x: "0px", y: "0px", width: "24px", height: "30px", viewBox: "0 0 24 30", xmlSpace: "preserve" },
            React.createElement("rect", { x: "0", y: "10", width: width, height: height, fill: color, opacity: "0.2" },
                React.createElement("animate", { attributeName: "opacity", attributeType: "XML", values: "0.2; 1; .2", begin: "0s", dur: duration, repeatCount: "indefinite" }),
                React.createElement("animate", { attributeName: "height", attributeType: "XML", values: "10; 20; 10", begin: "0s", dur: duration, repeatCount: "indefinite" }),
                React.createElement("animate", { attributeName: "y", attributeType: "XML", values: "10; 5; 10", begin: "0s", dur: duration, repeatCount: "indefinite" })),
            React.createElement("rect", { x: "8", y: "10", width: width, height: height, fill: color, opacity: "0.2" },
                React.createElement("animate", { attributeName: "opacity", attributeType: "XML", values: "0.2; 1; .2", begin: "0.15s", dur: duration, repeatCount: "indefinite" }),
                React.createElement("animate", { attributeName: "height", attributeType: "XML", values: "10; 20; 10", begin: "0.15s", dur: duration, repeatCount: "indefinite" }),
                React.createElement("animate", { attributeName: "y", attributeType: "XML", values: "10; 5; 10", begin: "0.15s", dur: duration, repeatCount: "indefinite" })),
            React.createElement("rect", { x: "16", y: "10", width: width, height: height, fill: color, opacity: "0.2" },
                React.createElement("animate", { attributeName: "opacity", attributeType: "XML", values: "0.2; 1; .2", begin: "0.3s", dur: duration, repeatCount: "indefinite" }),
                React.createElement("animate", { attributeName: "height", attributeType: "XML", values: "10; 20; 10", begin: "0.3s", dur: duration, repeatCount: "indefinite" }),
                React.createElement("animate", { attributeName: "y", attributeType: "XML", values: "10; 5; 10", begin: "0.3s", dur: duration, repeatCount: "indefinite" })))));
};
...
var Logo$2 = function (_a) {
    var isDark = _a.isDark, text = _a.text, props = __rest(_a, ["isDark", "text"]);
    var theme = useTheme();
    var textColor = (isDark) ? theme.colors.backgroundAlt : theme.colors.primaryDark;
    return (React.createElement(React.Fragment, null,
        React.createElement("svg", __assign({ height: "60", width: "200" }, props),
            React.createElement("text", { x: "5", y: "38", fontSize: "22", fill: textColor }, text))));
};
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 1000 1000" }, props),
        React.createElement("g", null,
            React.createElement("g", { transform: "translate(0.000000,511.000000) scale(0.100000,-0.100000)" },
                React.createElement("path", { d: "M945.2,4981.4c-208.4-76-380.1-255-434-458.6c-17.2-58.8-22.1-1476.2-19.6-4073l7.3-3979.9l66.2-110.4c85.8-147.1,179-230.5,326.1-299.2c107.9-49.1,169.2-56.4,546.8-63.8l421.8-9.8v-267.3c0-311.4,31.9-416.9,147.1-475.7c63.8-34.3,171.7-36.8,799.4-31.9l725.9,7.4l71.1,80.9c71.1,78.5,71.1,80.9,71.1,385v306.5h1324.2h1324.2v-306.5c0-304.1,0-306.5,71.1-385l71.1-80.9l725.8-7.4c627.7-4.9,735.6-2.5,799.4,31.9c115.3,58.9,147.1,164.3,147.1,475.7v267.3l424.2,9.8c495.3,9.8,613,46.6,777.3,232.9c186.4,210.9,174.1-120.2,166.7,4323.2c-7.3,3830.3-9.8,3987.2-54,4070.6c-63.7,120.2-206,264.8-321.2,326.1l-98.1,54l-3997,4.9C1725,5013
                React.createElement("path", { d: "M4709.3,1227.1c-338.4-93.2-551.7-377.6-549.3-730.7c0-215.8,80.9-387.4,255-544.4c380.1-340.9,1025-174.1,1186.8,311.4c54,164.3,36.8,434-34.3,576.3C5408.1,1148.6,5035.4,1317.8,4709.3,1227.1z M5030.5,837.2c132.4-56.4,196.2-144.7,208.4-291.8c19.6-233-115.3-385-338.4-385c-149.6,0-259.9,71.1-321.3,208.4c-58.8,134.9-44.1,252.6,46.6,360.5C4736.2,861.7,4883.3,900.9,5030.5,837.2z" })))));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        ...
        React.createElement(LogoWithText, { className: "desktop-icon", isDark: isDark, text: "RUG-PULL" })));
    return (React.createElement(Flex, { alignItems: "center" },
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "RugPull home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "RugPull home page" }, innerLogo))));
};
...
var LangSelector = function (_a) {
    var currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang, position = _a.position;
    return (React.createElement(Dropdown, { position: position || "top-right", target: React.createElement(Button, { variant: "text", startIcon: React.createElement(Icon$16, { color: "textSubtle", width: "24px" }) },
...
var Menu$1 = styled.div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n\tdisplay: none;\n\t", " {\n\t\tdisplay: flex;\n\t}\n"], ["\n\tdisplay: none;\n\t", " {\n\t\tdisplay: flex;\n\t}\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var TopMenu = function (props) {
    ...
    return (React.createElement(Menu$1, null, links.map(function (entry) {
        ...
        return (React.createElement(MenuItem, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, onClick: handleClick }, entry.label)));
    })));
};
...
var Menu = function (_a) {
    ...
    var SettingsEntry = styled.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    display: none;\n\n    ", " {\n      display: flex;\n    }\n\n    button {\n      padding: 0 1rem;\n    }\n  "], ["\n    display: none;\n\n    ", " {\n      display: flex;\n    }\n\n    button {\n      padding: 0 1rem;\n    }\n  "])), function (_a) {
        var theme = _a.theme;
        return theme.mediaQueries.nav;
    });
    var FlexStyled = styled(Flex)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    align-items: center;\n    justify-content: flex-end;\n  "], ["\n    align-items: center;\n    justify-content: flex-end;\n  "])));
    // Find the home link if provided
    var homeLink = links.find(function (link) { return link.label === "Home"; });
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React.createElement(TopMenu, { links: links, isMobile: isMobile, pushNav: setIsPushed, isPushed: isPushed }),
            !!login && !!logout && (React.createElement(FlexStyled, null,
                React.createElement(SettingsEntry, null,
                    React.createElement(ThemeSwitcher$1, { isDark: isDark, toggleTheme: toggleTheme }),
                    React.createElement(LangSelector$1, { currentLang: currentLang, langs: langs, setLang: setLang, position: "bottom" })),
...
export { Icon$1z as AddIcon, Alert, Icon$1y as ArrowBackIcon, Icon$1x as ArrowDownIcon, Icon$1w as ArrowDropDownIcon, Icon$1v as ArrowDropUpIcon, Icon$1u as ArrowForwardIcon, Icon$1t as ArrowUpIcon, Icon$1s as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1r as BinanceIcon, Icon$1B as BlockIcon, Icon$1q as BnbUsdtPairTokenIcon, Box, Breadcrumbs, Icon$1p as BunnyCardsIcon, Icon$1o as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1l as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1m as CardViewIcon, Icon$1n as Cards, GridLayout as CardsLayout, Icon$1j as ChartIcon, Checkbox, Icon$1D as CheckmarkCircleIcon, Icon$1i as CheckmarkIcon, Icon$1h as ChevronDownIcon, Icon$1g as ChevronLeftIcon, Icon$1f as ChevronRightIcon, Icon$1e as ChevronUpIcon, Icon$1k as CircleOutlineIcon, Icon$1d as CloseIcon, Icon$1c as CogIcon, ColorplateCard as ColorPalette, Icon$1b as CommunityIcon, ConnectorNames, Icon$1a as CopyIcon, Icon$19 as CrownIcon, Dropdown, Icon$1C as ErrorIcon, ExpandableButton, ExpandableLabel, Flex, Grid, Heading, Icon$18 as HelpIcon, Icon$17 as HistoryIcon, IconButton, Image, Icon$1A as InfoIcon, Input$1 as Input, Icon$16 as LanguageIcon, Icon$15 as LaurelLeftIcon, Icon$14 as LaurelRightIcon, Link, LinkExternal, Icon$13 as ListViewIcon, Icon$12 as LogoIcon, Icon$11 as LogoRoundIcon, Icon$10 as MedalBronzeIcon, Icon$$ as MedalGoldIcon, Icon$_ as MedalPurpleIcon, Icon$Z as MedalSilverIcon, Icon$Y as MedalTealIcon, Menu, Message, Icon$X as MetamaskIcon, Icon$W as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$V as NoProfileAvatarIcon, NotificationDot, Icon$U as OpenNewIcon, Icon$S as PancakeRoundIcon, Icon$T as PancakesIcon, Icon$Q as PlayCircleOutlineIcon, Icon$R as PocketWatchIcon, Icon$P as PrizeIcon, Progress, Icon$L as ProgressBunny, Icon$O as ProposalIcon, Radio, Icon$q as RefreshIcon, Icon$N as RemoveIcon, ResetCSS, Icon$B as SearchIcon, Skeleton, Slider, Spinner, Icon$A as StarFillIcon, Icon$z as StarLineIcon, Step, Stepper, Svg, Icon$y as SwapVertIcon, Icon$x as SyncAltIcon, Tab, ButtonMenu as TabMenu, Tag, Icon$I as TeamPlayerIcon, Icon$H as TestnetIcon, Text, Icon$G as Ticket, Icon$F as TicketRound, Icon$E as TimerIcon, ToastContainer, Toggle, TokenImage, TokenPairImage, TooltipText, Icon$D as TrophyGoldIcon, Icon$C as TuneIcon, Icon$M as VerifiedIcon, Icon$w as VisibilityOff, Icon$v as VisibilityOn, Icon$u as VolumeOffIcon, Icon$t as VolumeUpIcon, Icon$s as VoteIcon, Icon$K as WaitIcon, Icon$r as WarningIcon, Icon$J as Won, variants$4 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal };
